...
# LOG DIRECTORY
LOG_DIR="log/Feature_AKAZE_First"
...
echo "Script:      registration/feature_akaze_first.py"
echo "Input:       TMA_Cores_Grouped_NEW/<CORE>/<CORE>_Amoeba_Aligned.ome.tif"
echo "Output:      Feature_AKAZE_First/"
...
for i in $(seq $START $END); do
    ...
    python registration/feature_akaze_first.py --core_name "${CORE_NAME}" \
