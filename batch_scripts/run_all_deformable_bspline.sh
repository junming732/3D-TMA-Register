...
# LOG DIRECTORY
LOG_DIR="log/deformable_bspline"
...
echo "============================================"
echo "Starting Sequential Processing (Feature/AKAZE): Core_$(printf "%02d" $START) to Core_$(printf "%02d" $END)"
echo "Script:      registration/deformable_bspline.py"
echo "Input:       TMA_Cores_Grouped_rotate/<CORE>/<CORE>.ome.tif"
echo "Output:      deformable_bspline/"
...
for i in $(seq $START $END); do
    ...
    python registration/deformable_bspline.py --core_name "${CORE_NAME}" \
