...
# LOG DIRECTORY
LOG_DIR="log/amoeba_noGgeometry"
...
echo "Script:      amoeba_meansquares_noGeometry.py"
...
for i in $(seq $START $END); do
    ...
    python registration/amoeba_meansquares_noGeometry.py --core_name "${CORE_NAME}" > "${LOG_DIR}/${CORE_NAME}.log" 2>&1
