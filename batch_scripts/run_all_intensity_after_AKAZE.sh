...
# LOG DIRECTORY
LOG_DIR="log/intensity_after_AKAZE"
...
echo "Script:      intensity_after_AKAZE.py"
...
for i in $(seq $START $END); do
    ...
    python registration/intensity_after_AKAZE.py --core_name "${CORE_NAME}" > "${LOG_DIR}/${CORE_NAME}.log" 2>&1
