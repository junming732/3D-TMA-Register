...
echo "Script:      registration/feature_akaze_noLimit.py"
echo "Input:       Amoeba_Registered_rigid_geometry/<CORE>/<CORE>_Amoeba_Aligned.ome.tif"
echo "Output:      Feature_Registered_noLimit/"
...
for i in $(seq $START $END); do
    ...
    python registration/feature_akaze_noLimit.py --core_name "${CORE_NAME}" \
