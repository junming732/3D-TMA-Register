...
# LOG DIRECTORY
LOG_DIR="log/feature_noGeometry"
...
echo "Script:      registration/feature_akaze_noGeometry.py"
echo "Input:       Amoeba_Registered_noGeometry/<CORE>/<CORE>_Amoeba_Aligned.ome.tif"
echo "Output:      Feature_Registered_noGeometry/"
...
for i in $(seq $START $END); do
    ...
    python registration/feature_akaze_noGeometry.py --core_name "${CORE_NAME}" \
