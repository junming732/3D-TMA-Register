...
echo "Script:      registration/feature_log.py"
echo "Input:       TMA_Cores_Grouped_NEW/<CORE>/<CORE>_Amoeba_Aligned.ome.tif"
echo "Output:      Feature_logarithm/"
...
for i in $(seq $START $END); do
    ...
    python registration/feature_log.py --core_name "${CORE_NAME}" \
