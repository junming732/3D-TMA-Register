...
REGISTRATION_MODE="color_lut"   # ck_only | 3ch_fusion | color_lut
# LOG DIRECTORY
LOG_DIR="log/filter_akaze_tissue_mask_bsplin_multi_channel/${REGISTRATION_MODE}"
...
for i in $(seq $START $END); do
    ...
    python registration/akaze_tissue_mask_bspline_multi_channel.py \
    --core_name "${CORE_NAME}" \
