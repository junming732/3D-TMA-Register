...
WORK_OUTPUT       = os.path.join(config.DATASPACE, "Feature_Registered_noLimit")
...
MAX_ROTATION_DEG     = 30.0  # Maximum allowed rotation in degrees — adjust to tissue biology
MAX_TRANSLATION_PX   = 800.0 # Maximum allowed translation in pixels — adjust to image dimensions
