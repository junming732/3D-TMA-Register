...
WORK_OUTPUT = os.path.join(config.DATASPACE, "Amoeba_Registered") 
...
def register_slice_amoeba(fixed_full_image, moving_full_image):
    ...
    try:
        ...
        # Matrix is params[0:4], Translation is params[4:6]
        # Just logging translation for simplicity in summary
        shift_x = params[4]
        shift_y = params[5]
